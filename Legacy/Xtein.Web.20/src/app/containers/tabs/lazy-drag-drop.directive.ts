...
import { AfterViewInit, Input, Directive, ElementRef, QueryList, OnDestroy, Optional } from '@angular/core';
...
export class CdkLazyDropList<T = any> extends CdkDropList<T> {
  ...
  enter(item: CdkDrag, pointerX: number, pointerY: number): void {
    super._dropListRef.enter(item._dragRef, pointerX, pointerY);
