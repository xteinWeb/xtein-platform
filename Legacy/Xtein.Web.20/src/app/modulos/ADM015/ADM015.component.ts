...
import { ADM01506Component } from './ADM01506/ADM01506.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DxFormModule, DxValidatorModule, DxDropDownBoxModule, DxDataGridModule,
    DxSelectBoxModule, DxTabPanelModule, DxRadioGroupModule, DxButtonModule, DxPopupModule, DxTextBoxModule,
    ADM01501Component, ADM01502Component, ADM01503Component, ADM01504Component, ADM01505Component, ADM01506Component, VistarapidaComponent, DxLoadPanelModule
  ]
})
  ...
  opPrepararGuardar(accion: string): void {
    ...
    const prmDatosGuardar = JSON.parse(
      (JSON.stringify({ USUARIOS: this.DUsuarios }) +
        ...
        JSON.stringify({ APL_ASOCIADAS: this._sdatos.D_AplicacionesAsociadas ??= [] })
      ).replace(/}{/g, ",")
    );
