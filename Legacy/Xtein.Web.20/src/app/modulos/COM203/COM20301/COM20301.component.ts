...
export class COM20301Component {
        ...
        this._sdatos
          ...
          .subscribe((resp) => {
            ...
            if (res[0].ErrMensaje == "") {
              ...
              console.log("infoRest", this.infoExis);
            }
          });
  ...
  onSeleccAccion(e) {
    ...
    this._sdatos.consulta('configuracion acciones', prm, 'COM-203').subscribe((data: any) => {
      ...
      if (res[0].tipo === 'popup') {
        ...
        this.valoresObjetos('ventana acciones', {
          operacion: 'ver',
          config: res[0],
          prmDatos: this.DMovimientos
        })
    ...
    if (e.selectedRowKeys[0]) {
      if (this.DMovimientosItems.findIndex((d: any) => d.PRODUCTO === e.selectedRowKeys[0]) === -1) {
        ...
        if (dnompro) {
          ...
          cellInfo.data.UBICACION = dnompro.UBICACION;
  ...
  valoresObjetos(obj: string, opcion: any = undefined) {
    ...
    if (obj == 'productos' &&
      ...
      const prm = {
        ID_CONDICION: this.DMovimientos.ID_CONDICION,
    ...
    if (obj == 'gravamenes' || obj == 'ref') {
      ...
      if (opcion !== 'original')
        prm = {
          ORDEN_COMPRA: this.DMovimientos,
