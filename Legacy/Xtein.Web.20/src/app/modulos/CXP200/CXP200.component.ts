...
export class CXP200Component {
  ...
  opPrepararGuardar(accion: string): void {
    ...
    const prmDatosGuardar = {
      ...
      BANCOS: this.DBancos,
      CARACTERISTICAS: this.DCondiciones.CARACTERISTICAS || [],
      USUARIO: this.prmUsrAplBarReg.usuario
    }
  ...
  opIrARegistro(accion: string): void {
    ...
    try {
      ...
      this.DCondiciones = {
        CONDICIONES: this.FAcreedores["CONDICIONES"],
        ADICIONALES: this.FAcreedores["CONDICIONES_ADIC"],
        CARACTERISTICAS: this.FAcreedores["CARACTERISTICAS"]
      };
