...
import { FIN20203Component } from './FIN20203/FIN20203.component';
...
@Component({
  ...
  styleUrls: ['./FIN202.component.scss'],
    ...
    imports: [CommonModule, DxFormModule, DxSelectBoxModule, CdkAccordionModule, DxDropDownBoxModule,
              ...
              FIN20201Component, FIN20202Component, FIN20203Component
            ]
})
export class FIN202Component {
  ...
  eventsSubjectPreRecaudo: Subject<any> = new Subject<any>();
    ...
    switch (res[0].tipoAccion) {
      ...
      case "componente":
        ...
        switch (res[0].titulo) {
          ...
          case "Pre-recaudo":
            this.eventsSubjectPreRecaudo.next({
              dataRecaudo: datRecaudo,
              dataSource: res[0].dataSource,
              dataSelecc: this.DRecaudoPagos
            });
  ...
  async onRespuestaSettings(e: any) {
    ...
    // Cargue del pre-recaudo
    if (e.titulo == 'Pre-recaudo') {
      this.eventsSubjectPreRecaudo.next({
        dataRecaudo: this.DRecaudo,
        dataSource: e.rowsSelected
      });

      // Total seleccionado
      /*
      const prm:any = { ACCION: e.titulo,para yo montarlo y de ahi en daelante solo es copiar
