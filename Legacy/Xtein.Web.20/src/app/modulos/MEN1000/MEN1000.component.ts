...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DxButtonModule, DxToolbarModule, DxoSearchPanelModule, DxSelectBoxModule,
            DxDataGridModule, DxTextBoxModule, DxDropDownButtonModule, DxLoadPanelModule,
            FiltrobusqComponent
          ]
})
