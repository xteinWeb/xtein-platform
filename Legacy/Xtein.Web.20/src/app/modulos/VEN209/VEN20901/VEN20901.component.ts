...
import { clsAdicProveedores, clsCondicionesProv } from '../clsVEN209.class';
...
import { VEN20902Component } from '../VEN20902/VEN20902.component';

@Component({
  selector: 'VEN20901',
  templateUrl: './VEN20901.component.html',
  styleUrls: ['./VEN20901.component.css'],
  standalone: true,
  imports: [DxDataGridModule, CommonModule, DxFormModule, DxSelectBoxModule, DxButtonModule,
    DxNumberBoxModule, CdkAccordionModule
  ]
})

export class VEN20901Component {
  ...
  refreshClick(tipo) {
    this.valoresObjetos('condiciones', { TIPO: 'CLIENTE' });
  ...
  valoresObjetos(obj: string, opcion: any = undefined) {
    ...
    if (obj == 'condiciones' || obj == 'todos') {
      opcion = opcion == undefined ? { TIPO: 'VENTAS'} : opcion;
      // opcion = opcion == undefined ? { TIPO: 'CLIENTE', ESTADO: 'ACTIVO' } : opcion;
      const prm = opcion;
      this._sdatos
