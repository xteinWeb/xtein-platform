...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DxFormModule, DxDataGridModule, DxDropDownBoxModule, DxTextBoxModule, DxNumberBoxModule, 
            DxButtonModule, DxTreeListModule, DxRadioGroupModule, CdkAccordionModule, DxLoadPanelModule, DxPopupModule, 
            DxListModule, DxDateBoxModule ]
})
