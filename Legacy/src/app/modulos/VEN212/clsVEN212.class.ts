...
export class clsFacturas{
  ...
  public FECHA_ULT_VENC: Date;
  public CLIENTE_PADRE: string;
  public BANCO: string;
}

export class clsFacturasPagos{
  public ITEM: number;
  public ID_RECAUDO: string;
  public NC_RECAUDO: string;
  public FECHA: Date;
  public ID_PEDIDO: string;
  public NC_PEDIDO: string;
  public SALDO: number;
  public VALOR: number;
}

export class clsFacturasItems{
  public ID_UN: string;
  public ID_UN_ITEM: string;
  public ID_DOCUMENTO: string;
  public PREFIJO: string;
...
export class clsFacturaGravAux {
  public ITEM: number;
  public PRODUCTO: string;
  public ATRIBUTO: string;
  public GRAV_ORG: any;
