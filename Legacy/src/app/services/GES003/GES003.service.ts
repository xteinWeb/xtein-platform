...
export class GES003Service {
  ...
  getExisteIdCargo(Accion: string, prmDatos: any): Observable<any> {    
    ...
    let url = this.endPoint+'/GES003/existeIdCargo';
  ...
  getDominios(Accion: string, prmDatos: any): Observable<any> {
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint+'/GES003/dominios';
  ...
  getIntegridad(Accion: string, prmDatos: any): Observable<any> {    
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint+'/GES003/integridad';
    return this.http.post<any>(url, body,
      {headers: {'Content-Type': 'application/json' } }).
      pipe(
        map((vec: any) => {
  ...
  getActividad(Accion: string, prmDatos: any): Observable<any> {    
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint+'/GES003/actividad';
    return this.http.post<any>(url, body,
      {headers: {'Content-Type': 'application/json' } }).
      pipe(
        map((vec: any) => {
  ...
  consulta(accion: any, prmDatos: any): Observable<any> {
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint+'/GES003/consulta';
    return this.http.post<any>(url, body,
      { headers: {'Content-Type': 'application/json' } }).
      pipe(
      map((vec: any) => {
  ...
  getCargos(accion: any, prmDatos: any, aplicacion: any): Observable<any> {
    ...
    const body = JSON.stringify(prmJ);    
    aplicacion = aplicacion.replace('-','');
    let url = this.endPoint+'/'+aplicacion+'/cargos';
    return this.http.post<any>(url, body,
      { headers: {'Content-Type': 'application/json' } }).
      pipe(
      map((vec: any) => {
  ...
  save(Accion: string, prmDatos: any): Observable<any> {
    ...
    const body = JSON.stringify(prmJ);    
    let url = this.endPoint+'/GES003/save';
