...
@Component({
  ...
  standalone: true,
  providers: [ DatePipe ],
  imports: [CommonModule, DxPopupModule, DxFormModule, DxSelectBoxModule, DxNumberBoxModule, DxRadioGroupModule, DxButtonGroupModule, 
            DxDateBoxModule, DxSwitchModule, DxPopupModule, DxButtonModule, DxCalendarModule ]
})
