...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the ADM microfrontend.
     */
    name:
      'mfe-adm',
    ...
    /**
     * Components exposed by the ADM microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the ADM registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-adm/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the ADM
    ...
    features: {
       ...
       * actually used by the ADM microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the ADM microfrontend can reuse the same
