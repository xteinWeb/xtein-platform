...
/**
 * XTEIN platform mappings used by dynamically loaded ADM applications.
 *
 * ADM applications are resolved after bootstrap through
 * AdmApplicationRegistry. Native Federation's unused-dependency
