...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the INV microfrontend.
     */
    name:
      'mfe-inv',
    ...
    /**
     * Components exposed by the INV microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the INV registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-inv/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the INV
    ...
    features: {
       ...
       * actually used by the INV microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the INV microfrontend can reuse the same
