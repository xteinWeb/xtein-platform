...
/**
 * XTEIN platform mappings used by dynamically loaded INV applications.
 *
 * INV applications are resolved after bootstrap through
 * InvApplicationRegistry. Native Federation's unused-dependency
