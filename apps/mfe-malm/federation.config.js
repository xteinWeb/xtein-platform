...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the MALM microfrontend.
     */
    name:
      'mfe-malm',
    ...
    /**
     * Components exposed by the MALM microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the MALM registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-malm/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the MALM
    ...
    features: {
       ...
       * actually used by the MALM microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the MALM microfrontend can reuse the same
