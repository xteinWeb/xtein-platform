...
/**
 * XTEIN platform mappings used by dynamically loaded MALM applications.
 *
 * MALM applications are resolved after bootstrap through
 * MalmApplicationRegistry. Native Federation's unused-dependency
