...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the MCOM microfrontend.
     */
    name:
      'mfe-mcom',
    ...
    /**
     * Components exposed by the MCOM microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the MCOM registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-mcom/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the MCOM
    ...
    features: {
       ...
       * actually used by the MCOM microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the MCOM microfrontend can reuse the same
