/** Routes and actions verified against the active legacy application. */
export const Ven230Catalog = {
 ...
 conditions: ['/VEN230/consulta', 'CONDICIONES LISTAS'],
...
export const Ven230BusinessAction = {
 taxes: 'GRAVAMENES', quantity: 'actualizar cantidad', stock: 'EXISTENCIAS PRODUCTO',
 settings: 'acciones settings', load: 'cargar datos'
} as const;
