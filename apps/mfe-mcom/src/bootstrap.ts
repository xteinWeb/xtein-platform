...
/**
 * XTEIN platform mappings used by dynamically loaded MCOM applications.
 *
 * MCOM applications are resolved after bootstrap through
 * McomApplicationRegistry. Native Federation's unused-dependency
