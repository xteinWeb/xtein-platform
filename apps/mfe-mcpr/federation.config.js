...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the MCPR microfrontend.
     */
    name:
      'mfe-mcpr',
    ...
    /**
     * Components exposed by the MCPR microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the MCPR registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-mcpr/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the MCPR
    ...
    features: {
       ...
       * actually used by the MCPR microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the MCPR microfrontend can reuse the same
