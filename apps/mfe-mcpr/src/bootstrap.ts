...
/**
 * XTEIN platform mappings used by dynamically loaded MCPR applications.
 *
 * MCPR applications are resolved after bootstrap through
 * McprApplicationRegistry. Native Federation's unused-dependency
