...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the MEN microfrontend.
     */
    name:
      'mfe-men',
    ...
    /**
     * Components exposed by the MEN microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the MEN registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-men/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the MEN
    ...
    features: {
       ...
       * actually used by the MEN microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the MEN microfrontend can reuse the same
