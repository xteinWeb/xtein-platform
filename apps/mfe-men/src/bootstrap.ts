...
/**
 * XTEIN platform mappings used by dynamically loaded MEN applications.
 *
 * MEN applications are resolved after bootstrap through
 * MenApplicationRegistry. Native Federation's unused-dependency
