...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the MFIN microfrontend.
     */
    name:
      'mfe-mfin',
    ...
    /**
     * Components exposed by the MFIN microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the MFIN registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-mfin/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the MFIN
    ...
    features: {
       ...
       * actually used by the MFIN microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the MFIN microfrontend can reuse the same
