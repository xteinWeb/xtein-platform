...
/**
 * XTEIN platform mappings used by dynamically loaded MFIN applications.
 *
 * MFIN applications are resolved after bootstrap through
 * MfinApplicationRegistry. Native Federation's unused-dependency
