...
module.exports =
  withNativeFederation({
    ...
    /**
     * Native Federation identifier of the MTHU microfrontend.
     */
    name:
      'mfe-mthu',
    ...
    /**
     * Components exposed by the MTHU microfrontend.
     *
     * The Shell loads ApplicationHost and passes the requested
     * XTEIN application identifier so the MTHU registry can resolve
     * the corresponding functional application dynamically.
     */
    exposes: {

      './ApplicationHost':
        './apps/mfe-mthu/src/app/application-host/application-host.component.ts'
    },
     ...
     *
     * These packages remain bundled locally by the MTHU
    ...
    features: {
       ...
       * actually used by the MTHU microfrontend.
       */
      ignoreUnusedDeps:
        true,
       ...
       * the Shell and the MTHU microfrontend can reuse the same
