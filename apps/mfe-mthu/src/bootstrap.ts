...
/**
 * XTEIN platform mappings used by dynamically loaded MTHU applications.
 *
 * MTHU applications are resolved after bootstrap through
 * MthuApplicationRegistry. Native Federation's unused-dependency
