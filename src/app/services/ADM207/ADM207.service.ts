...
export class ADM207Service {
  ...
  save(prmAccion: any, prmDatos: any): Observable<any> {
    console.log(prmAccion);
    console.log(prmDatos);
    const prmJ = {
      prmAccion: prmAccion,
      prmDatos: JSON.stringify(prmDatos),
      prmConexion: { EMPRESA: localStorage.getItem('empresa') },
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint + '/ADM207/update';
  ...
  delete(prmAccion: any, prmDatos: any): Observable<any> {
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint + '/ADM207/' + prmAccion;
  ...
  getIntegridad(Accion: string, prmDatos: any): Observable<any> {
    ...
    const body = JSON.stringify(prmJ);
    let url = this.endPoint + '/ADM207/integridad';
    return this.http
      .post<any>(url, body, {
        headers: {
          'Content-Type': 'application/json'
